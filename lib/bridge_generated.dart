...
class GreeterImpl extends FlutterRustBridgeBase<GreeterWire>
    implements Greeter {
  factory GreeterImpl(ffi.DynamicLibrary dylib) =>
      GreeterImpl.raw(GreeterWire(dylib));

  GreeterImpl.raw(GreeterWire inner) : super(inner);
...
/// generated by flutter_rust_bridge
class GreeterWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  GreeterWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  GreeterWire.fromLookup(
